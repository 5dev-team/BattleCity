...
describe('Wrapper NesAvatar', () => {
  test('Should render standard NesAvatar', () => {
    ...
    expect(logoProfile).toHaveAttribute('class', 'nes-avatar is-undefined  avatar')
  })
  test('Should render NesAvatar from props', () => {
    ...
    expect(logoProfile).toHaveAttribute('class', 'nes-avatar is-medium is-rounded avatar')
  })
})
